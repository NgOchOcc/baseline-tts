"""
Baseline evaluation for MINERVA questions.
Simply takes output[0] (first output) as final answer and evaluates.
No voting, no selection strategy - just the first completion.
"""
...
def baseline_evaluation():
    """Evaluate using output[0] as final answer for all questions."""
    ...
    print("=" * 80)
    print("BASELINE: Taking output[0] as final answer")
    print("=" * 80)
    print()
    ...
    # Print summary
    print("\n" + "=" * 80)
    print("BASELINE RESULTS (output[0] only)")
    print("=" * 80)
    print()
    ...
    output_file = base_dir / "baseline_result.json"
    ...
    avg_result_file = base_dir / "avg_result.json"
    if avg_result_file.exists():
        print("=" * 80)
        print("COMPARISON WITH VOTING STRATEGIES")
        print("=" * 80)
        print()
